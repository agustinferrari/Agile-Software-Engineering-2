...
| Cargar parada 2 | General Flores General Flores General Flores |     1      | Punto de carga  | the direction must be alphanumeric with a maximum of 30 characters |
| Cargar parada 2 | Direccion @2 !..% |     1      | Punto de carga  | the direction must be alphanumeric with a maximum of 30 characters |
| Cargar parada 2 | General Flores |    0   | Punto de carga  | the region should be previously registered on the system, |
